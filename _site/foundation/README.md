...
```mermaid
graph TD
    H[DALLAS-PLANT-PROD-FAC-001] -->|HAS_TEAM| G[DALLAS-PROD-OPS-TEAM-001]
    G -->|HAS_MEMBER| A[WTR-QUAL-AGENT-001]
    G -->|HAS_MEMBER| C[MAINT-ENG-AGENT-001]
    G -->|HAS_MEMBER| E[OPS-MGT-AGENT-001]
    A -->|INSTANCE_OF| B[WTR-QUAL-PROFILE-001]
    C -->|INSTANCE_OF| D[MAINT-ENG-PROFILE-001]
    E -->|INSTANCE_OF| F[OPS-MGT-PROFILE-001]
```
