...
[^4]: [Coralogix - Prompt Injection Attacks in LLMs: What They Are & How to Prevent Them](https://coralogix.com/ai-blog/prompt-injection-attacks-in-llms-what-are-they-and-how-to-prevent-them/)
...
[^12]: [NCC Group - Exploring Prompt Injection Attacks](https://www.nccgroup.com/au/research-blog/exploring-prompt-injection-attacks/)
[^13]: [AI Safety - Prompt Injection Prevention](https://www.aisafety.guide/prompt-injection)
[^14]: [Google Cloud - Model Armor (LLM prompt injection & jailbreak protection)](https://docs.cloud.google.com/security-command-center/docs/model-armor-overview)
[^15]: [AWS Prescriptive Guidance - Best Practices to Avoid Prompt Injection Attacks](https://docs.aws.amazon.com/prescriptive-guidance/latest/llm-prompt-engineering-best-practices/best-practices.html)
[^16]: [OpenAI - Safety Best Practices](https://developers.openai.com/api/docs/guides/safety-best-practices)