...
CREATE CONSTRAINT plan_id_unique IF NOT EXISTS FOR (p:Artifact) REQUIRE p.id IS UNIQUE;
CREATE CONSTRAINT conversation_id_unique IF NOT EXISTS FOR (c:Artifact) REQUIRE c.id IS UNIQUE;
