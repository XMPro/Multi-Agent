# NCalc Tool — Mathematical Expression Evaluation
...
This is an **internal tool**: it is hardcoded into the MAGS agent framework and does not require a database entry, external API, or agent profile configuration to be available.
...
**Key benefits:**
- **Accuracy** — Deterministic evaluation eliminates LLM arithmetic errors
- **Auditability** — Both the generated expression and result are logged
- **Zero configuration** — Available to all agents without setup
- **Natural language input** — Agents do not need to know NCalc syntax
...
- [Tool Orchestration](tool-orchestration.md) — Tool categories and execution patterns
- [Telemetry & Observability](telemetry-observability.md) — Event IDs and metrics
- [Integration & Execution Overview](README.md) — Category overview

### Core Concepts
- [Tools, Actions, and Data Streams](../concepts/tools-actions-datastreams.md) — Tool fundamentals
